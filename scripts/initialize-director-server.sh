...
sudo wget -t 5 https://raw.githubusercontent.com/sysgain/cloudera-spectra-vip-new/master/cloudera-director.repo -O /etc/yum.repos.d/cloudera-director.repo >> ${LOG_FILE}
