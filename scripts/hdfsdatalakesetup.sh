...
echo "Cloudera Manager Node private IPAddress: $ManagerIP" >> /home/cloudera/NodeDetails
...
#curl -X POST -u admin:admin 'http://'${ManagerIP}':7180/api/v1/clusters/'${ClusterName}'/services/'${HDFS}'/commands/restart'
#sleep 60
#curl -X POST -u admin:admin 'http://'${ManagerIP}':7180/api/v1/clusters/'${ClusterName}'/commands/restart'
